            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form class="m-3" wire:submit="create" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <div><!--[if BLOCK]><![endif]--><?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]--></div>
                    ...
                    <div class="mb-6">
                        ...
                        <div><!--[if BLOCK]><![endif]--><?php $__errorArgs = ['desc'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]--></div>
                    ...
                    <div class="mb-6">
                        ...
                        <div><!--[if BLOCK]><![endif]--><?php $__errorArgs = ['file'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]--></div>
                    ...
                    <div class="mb-6">
                        ...
                        <select id="large" wire:model="status" name="status" class="block w-full px-4 py-3 text-base text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option value="-1" selected>Tanlang</option>
                            <option value="1" selected>Active</option>
                            <option value="0">Inactive</option>
                        </select>
                        <div><!--[if BLOCK]><![endif]--><?php $__errorArgs = ['status'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
<?php /**PATH D:\OSPanel\domains\mindshelf\resources\views/livewire/base-create.blade.php ENDPATH**/ ?>